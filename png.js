...
(function () {
    ...
    function styles(el, options, cssLoadedCallback) {
            ...
            if (rules != null) {
                for (let j = 0, match; j < rules.length; j++ , match = null) {
                    ...
                    if (typeof (rule.style) != "undefined") {
                        ...
                        if (match) {
                            const selector = selectorRemap ? selectorRemap(rule.selectorText) : rule.selectorText;
                            const cssText = modifyStyle ? modifyStyle(rule.style.cssText) : rule.style.cssText;
        ...
        function getFontMimeTypeFromUrl(fontUrl) {
            ...
            const extensions = Object.keys(supportedFormats);
    ...
    out$.svgAsPngUri = function (el, options, cb) {
        ...
        const convertToPng = function (src, w, h) {
            const canvas = document.createElement("canvas");
